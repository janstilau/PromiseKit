...
class ExampleViewController: UIViewController {
    ...
    private func showOrderSheet() {
        ...
        orderViewController.view.layer.borderColor = UIColor.yellow.cgColor
        orderViewController.view.layer.borderWidth = 2
...
extension ExampleViewController {
    func makeCardEntryViewController() -> SQIPCardEntryViewController {
        ...
        let vc = SQIPCardEntryViewController(theme: theme)
        vc.collectPostalCode = false
        return vc
    }
}
...
extension ExampleViewController: SQIPCardEntryViewControllerDelegate {
    func cardEntryViewController(_ cardEntryViewController: SQIPCardEntryViewController,
        ...
        let result = SQIPCardEntryCompletionStatus.success
        dismiss(animated: true) {
            switch result {
            case .canceled:
                self.showOrderSheet()
